    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.paragraph}>
          The Internet of Tsiken app uses the following open-source libraries. We are grateful to the developer community for their work.
        </Text>
        ...
        <Text style={styles.paragraph}>
          Copyright (c) NativeWind Contributors / Tailwind Labs, Inc.
          Licensed under the MIT License.
        </Text>
